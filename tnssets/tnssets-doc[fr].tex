...
\subsubsection{Ensembles pour la géométrie} \label{tnssets-geo-sets}
...
\subsubsection{Ensembles probabilistes} \label{tnssets-proba-sets}
...
\subsubsection{Ensembles pour l'algèbre générale} \label{tnssets-algebra-sets}
...
\subsubsection{Ensembles classiques en mathématiques et en informatique théorique} \label{tnssets-classical-sets}
